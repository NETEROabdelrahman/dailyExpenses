...
jest.mock('../src/store/appSlice', () => ({
  ...
  setTransferAmountText: (payload: string) => ({type: 'app/setTransferAmountText', payload}),
  setTransferFromPaymentMethod: (payload: string) => ({type: 'app/setTransferFromPaymentMethod', payload}),
  setTransferNotes: (payload: string) => ({type: 'app/setTransferNotes', payload}),
  setTransferToPaymentMethod: (payload: string) => ({type: 'app/setTransferToPaymentMethod', payload}),
